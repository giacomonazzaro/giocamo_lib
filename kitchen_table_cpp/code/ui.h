...
Rectangle place_next(const Rectangle& rect, int width, int height, const std::string& x, const std::string& y, int padding = 0);
Rectangle place_inside(const Rectangle& rect, int width, int height, const std::string& x, const std::string& y, int padding = 0);
...
bool immediate_button(
  Rectangle rect, const std::string& label,
...
struct UI_State {
  ...
  UI_State();
  Rectangle      place(int width, int height, const std::string& x = "left", const std::string& y = "top", int padding = 0) const;
